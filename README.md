...
<body>
    <header class="container text-center">
        <p class="lead">Eu sou Isis_</p>
        <h1>Eu estudo Programação na Alura</h1>
        <p> Estou estudando HTML, CSS e JavaScript. Veja os projetos que já desenvolvi!</p>
        <p>Estou desenvolvendo minhas habilidades em</p>
        <div>
    ...
    <main class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Recomendador de filmes</h5>
                        <p class="card-text">Este projeto é uma ferramenta para recomendar filmes com base nas respostas
                            que o usuário dá para simples perguntas sobre seus gostos cinematográficos.
                        </p>
                    </div>
                </div>
            </div>
